...
_vault         = Path(__file__).parent / 'strategy-test-vault' / 'v2.2.1-hybrid-shorts-intraday'
_vault.mkdir(parents=True, exist_ok=True)
REPORT_MD      = _vault / f'backtest-v2.2.1-hybrid-validation-report{_suffix}.md'
REPORT_JSON    = _vault / f'backtest-v2.2.1-hybrid-validation-report{_suffix}.json'
