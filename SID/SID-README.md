...
**Current version:** v1.6 — v1.5 filters + 14-day pre-PPI blackout + REFINED 47 watchlist (curated from 5-year backtest evidence). 5-year backtest on REFINED 47 (119 trades): **74.8% win rate, PF 3.20, +$12,574 net on $10k account at 2% risk per trade.** First version to clear the 65-85% community win-rate band. See [Version History](#version-history).
