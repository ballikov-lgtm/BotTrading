...
**Current version:** v1.5 — v1.4 filters + clarified pre-only earnings blackout. 5-year backtest (167 trades): **62.3% win rate, +$11,809 net on $10k account at 2% risk per trade.** Note: the earlier headline 77% WR was from a 12-month window — too small a sample to be trusted. v1.5 numbers reflect 5 years of real conditions. See [Version History](#version-history).
